					...
					<form>
						<div class="row">
							<div class="col-md-6 col-sm-12">
								...
								<label class="col-sm-12 col-md-12 col-form-label">Product</label>
								<div class="col-sm-12 col-md-10">
                                    <input class="form-control form-control-sm form-control-line" type="text" value="{{ $casesheader->PRDABBR }}" disabled>
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
                                <label class="col-sm-12 col-md-12 col-form-label">Agreement No</label>
								<div class="col-sm-12 col-md-10">
									<textarea class="form-control" value="{{ $casesheader->AGREEMENTNO }}" disabled>{{ $casesheader->AGREEMENTNO }}</textarea>
                                </div>
							</div>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						...
						@can('punb_casestatus-create')
							<a href="{{ route('casestatus.show', $casesheader->ID ) }}">
                                ...
                                <tr>
									@foreach ($cases as $case)
										<tr>
											...
											<td><a href="{{ route('ViewCases', $case->sis_id ) }}"><button class="btn btn-primary btn-sm"><i class="fa fa-search"></i></button></button></a></td>
										</tr>
									@endforeach
                                </tr>
                            </tbody>
