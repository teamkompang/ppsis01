...
@auth
							...
							<div class="row">
								<div class="col-md-6 col-sm-12">
									...
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" value="SIS{{ sprintf("%010d",$restructures->sis_id) }}" disabled>
									</div>
									<label class="col-sm-12 col-md-12 col-form-label">PUNB Officer</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" value="{{ $restructures->LADOFFICER }}" disabled>
									</div>
								</div>
								<div class="col-md-6 col-sm-12">
									<label class="col-sm-12 col-md-12 col-form-label">Case Status</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" value="{{ $restructures->value_details }}" disabled>
									</div>
									<label class="col-sm-12 col-md-12 col-form-label">Panel Solicitors</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" value="{{ $restructures->Name }}" disabled>
									</div>
								</div>
						...
						<form>
							<div class="row">
								<div class="col-md-6 col-sm-12">
									...
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" value="{{ $restructures->FULLNAME }}" disabled>
									</div>
									<label class="col-sm-12 col-md-12 col-form-label">Application Type</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" value="{{ $restructures->description }}" disabled>
									</div>
									<label class="col-sm-12 col-md-12 col-form-label">Restructure Amount (RM)</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" value="{{ number_format($restructures->AMOUNT,2)  }}" disabled>
									</div>
									<label class="col-sm-12 col-md-12 col-form-label">Meeting Name</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" value="{{ $restructures->MEETINGNAME }}" disabled>
									</div>
									<label class="col-sm-12 col-md-12 col-form-label">Date Approval</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" value="{{ date('d-m-Y', strtotime($restructures->DTMEETING)) }}" disabled>
									</div>
									
									<!-- <label class="col-sm-12 col-md-12 col-form-label">Application Status</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" value="{{ $restructures->FACSTATUS }}" disabled>
									</div> -->
								</div>
								<div class="col-md-6 col-sm-12">
									<label class="col-sm-12 col-md-12 col-form-label">Agreement No.</label>
									<div class="col-sm-12 col-md-10">
										<textarea class="form-control" disabled>{{ $restructures->case_no }}</textarea>
									</div>
									<!-- <label class="col-sm-12 col-md-12 col-form-label">Existing Facility</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" disabled>
									</div>
									<label class="col-sm-12 col-md-12 col-form-label">New Facility</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control form-control-sm form-control-line" type="text" disabled>
									</div> -->
											...
											<div class="pd-20">
												...
												<div class="clearfix mb-20">
													...
													<div class="pull-right">
														...
														<a href="{{route('punbrestructure.edit', [
															//$restructures->ID, 
															$id, 
															'output' => 'print',
															'page' => $com_restruc->currentPage()
														])}}" class="btn btn-primary" target="_blank">Print</a>

														@if ($statuscase->count())
															
														@else
															@if( $restructures->ICode == Auth::user()->company ||  Auth::user()->company == "PUNB" )
																@can('punb_restructure-create')
												...
												@if ($statuscase->count())
													<!-- disbaled -->
													<!-- <form action="{{ route('punbrestructure.update', $restructures->ID )  }}" method="POST" name="updatehead">
														@csrf
														@method('PATCH')
														<input class="form-control form-control-sm form-control-line" type="hidden" name="user_lastmaintain" value="{{ Auth::user()->fullname }}">
														<input class="form-control form-control-sm form-control-line" type="hidden" name="header_id" value="{{ $restructures->ID }}">
												...
												@else  
													@if( $restructures->ICode == Auth::user()->company ||  Auth::user()->company == "PUNB" )
														@can('punb_restructure-delete')
															<!-- active -->
															<form action="{{ route('punbrestructure.update', $restructures->sis_id )  }}" method="POST" name="updatehead">
																@csrf
																@method('PATCH')
																<input class="form-control form-control-sm form-control-line" type="hidden" name="user_lastmaintain" value="{{ Auth::user()->fullname }}">
																<input class="form-control form-control-sm form-control-line" type="hidden" name="header_id" value="{{ $restructures->ID }}">
	...
	@include('modal/punb/restructure/modalrestructure')
	@include('modal/punb/restructure/modalupload')
	@include('modal/punb/restructure/modalshowcase')
...
<script type="text/javascript">
	...
	$(function () {
		...
		var table = $('.data-table').DataTable({
			processing: true,
			serverSide: true,
			ajax: "{{ route('punbrestructure.edit', $id) }}",
			columns: [
	...
	$('body').on('click', '.ActiveItem', function () {
		...
		if (confirm("Are You sure want to hide comment ?") == true){
			$.ajax({
				type: "POST",
				url: "{{ route('RSTstatusActiveCase',$id) }}",
	...
	$('body').on('click', '.HideItem', function () {
		...
		if (confirm("Are You sure want to hide comment ?") == true){
			$.ajax({
				type: "POST",
				url: "{{ route('RSTstatusHideCase',$id) }}",
				data: { 'Item_id' : Item_id, 'user_lastmaintain' : user_lastmaintain },
				success: function (data) {
					location.reload();
				},
	...
	$('body').on('click', '#show-user', function () {
			...
			console.log(comm_id);
			$.get('/ViewCommentRestruc/'+comm_id, function (data) {
